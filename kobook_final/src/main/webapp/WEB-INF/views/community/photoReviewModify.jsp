			...
			<div class="container">
				<div class="row sub_content">
						...
						<div class="porDetCarousel">
							<div class="carousel-content">
								<img
									...
									alt="NO IMAGE" height="500" width="700">
							</div>
						</div>
					</div>
					...
					<form role="form" action="photoReviewModify" method="post"
						...
						<input type="hidden" name="photo_thumbnail"
							value="${photoVO.photo_thumbnail}"> <input type="hidden"
							name="photo_id" value="${photoVO.photo_id }">
						<div class="col-lg-4 col-md-4 col-sm-4">
							<div class="project_details">
								<div class="widget_title">
									<h4>
										<span><input type="text" name="photo_title"
											value="${photoVO.photo_title}"></span>
									</h4>
								</div>
								<ul class="details">
									<li><span><i class="fa fa-user"></i>작성자 :</span>${writer }</li>
									<li><span><i class="fa fa-file-text"></i>내용 :</span> <textarea
											cols="25" rows="2" name="photo_content"
