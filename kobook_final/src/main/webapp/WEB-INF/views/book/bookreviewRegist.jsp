...
<section class='rating-widget'>
  ...
  <div class='success-box'>
    ...
    <div class='clearfix'></div>
		...
		<textarea rows="10" cols="70" name="review_content"id="name" class="form-control" placeholder="내용을 입력하세요"></textarea>
		<input type="submit" value="글쓰기" id="submit" class="btn btn-default btn-lg button">
	</form>
	...
	<script type="text/javascript">
	  ...
	  $('#stars li').on('click', function(){
	    ...
	    var review_star = parseInt($('#stars li.selected').last().data('value'), 10);
	    var msg = "";
	    if (review_star > 1) {
