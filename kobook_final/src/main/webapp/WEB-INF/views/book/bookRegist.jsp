		...
		<div class="container">
			<div class="row sub_content">
				...
				<div class="col-lg-6 col-sm-6">
					...
					<form action="/book/bookRegist" id="subscribe" method="post"
						enctype="multipart/form-data">
						<input type="hidden" class="form-control" name="person_id"
							value="${person_id}"> <b>책이름:</b> <input type="text"
							name="book_name" id="name" class="form-control" placeholder="책이름">
						<b> 해시태그:</b> <input type="text" name="book_hash" id="hash"
							class="form-control" placeholder="ex) #공대 #공과대학"> <b>
							원가: </b> <input type="text" name="book_o_price" id="name"
							class="form-control" placeholder="원가" /> <b> 판매가: </b> <input
							type="text" name="book_m_price" id="name" class="form-control"
							placeholder="판매가" /> <b> 판: </b> <input type="text"
							name="book_edition" id="name" class="form-control"
							placeholder="판(없으면 빈칸도 좋아요)"> <b> 출판사: </b> <input
							type="text" name="book_publish" id="name" class="form-control"
							placeholder="출판사"> <b> 내용: </b>
						<textarea rows="10" cols="70" name="book_content" id="name"
						...
						<b> 안심여부:</b> <input type="radio" name="book_safe_yn" value="Y"
							...
							name="book_safe_yn" value="N">N &nbsp&nbsp <b> 책상태: </b><select
							name="book_status" id="status">
							<option value="B" selected="selected">보통</option>
							<option value="A">양호</option>
							<option value="C">미흡</option>
						</select> &nbsp;&nbsp; <b> 책종류: </b><select name="book_kind" id="kind">
						...
						</select><br> <b> 파일: </b><input type="file" name="file">
