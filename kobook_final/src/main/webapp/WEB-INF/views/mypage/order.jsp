												...
												<table  summary="" class="table table-hover">
													<tbody class="address_form ">
														...
														<tr>
															...
															<td><input id="ozipcode1" name="ozipcode1" class="inputTypeText" placeholder="${personVO.person_postcode}" size="6" maxlength="6" readonly="readonly" value="" type="text">
																- 
														...
														<tr>
															...
															<td>
																<input id="oemail1" name="oemail1" value="" type="text">@
																<input id="oemail2" name="oemail2" readonly="readonly" value="" type="text">
																	<select id="oemail3">
