  ...
  <!-- /헤더 -->
	...
	<section class="page_head">
		...
		<section class="content typography">
			...
			<!-- 모달 -->
		<div class="modal fade" id="content" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
					...
					<div class="modal-body">
						...
						<table class="table">
							<tr>
								<td>보낸 사람</td>
								<td>
									<input type="text" id="modal_person" value=""style="width: 300px;">
								</td>
								<td>
					...
					<div class="modal-footer">
						<div class="btn-group btn-group-justified" role="group" aria-label="group button">
							<div class="btn-group" role="group">
								<button type="button" class="btn btn-primary" data-dismiss="modal" role="button " id="modal_close">닫기</button>
							</div>
			...
			$(".btn-danger").click(
					function() {
						var message_id = $(this).parent().parent().find('td:first')
								.text().trim();
						location.href = "/mypage/msgDelete?message_id="+ message_id;
					});
